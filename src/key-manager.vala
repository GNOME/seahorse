...
public class Seahorse.KeyManager : Catalog {
    ...
    private const Gtk.ActionEntry[] GENERAL_ACTIONS = {
        ...
        { "file-import", Gtk.Stock.OPEN, N_("_Import…"), "<control>I", N_("Import from a file"), on_key_import_file },
        { "edit-import-clipboard", Gtk.Stock.PASTE, null, "<control>V", N_("Import from the clipboard"), on_key_import_clipboard }
    };
